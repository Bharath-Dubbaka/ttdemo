...
const teamMembers = [
  { name: "Edgar Gida", role: "Founder & Lead Artist", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400&auto=format&fit=crop" },
  { name: "Dr. Gauss", role: "Neo-Traditional", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=400&auto=format&fit=crop" },
  { name: "Germanis G", role: "Blackwork specialist", img: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=400&auto=format&fit=crop" },
  { name: "Katrina s.", role: "Fine-Line & Dotwork", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=400&auto=format&fit=crop" },
  { name: "Nils", role: "Realism Expert", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?q=80&w=400&auto=format&fit=crop" },
];
    ...
    <section className="relative w-full bg-black text-[#e4e2e6] py-24 px-6 md:px-12 border-b border-white/[0.05]">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-2">
          <span className="text-xs uppercase tracking-[0.25em] text-neutral-500 font-semibold">The Masters</span>
